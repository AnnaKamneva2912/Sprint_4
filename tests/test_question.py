...
class TestQuestionPart():
    def test_question_how_much(self, driver):
        ...
        question_how_much.scroll_to_question(QuestionPartLocators.question_how_much)
        question_how_much.click_on_question(QuestionPartLocators.question_how_much)
    ...
    def test_question_need_several(self, driver):
        ...
        question_need_several.scroll_to_question(QuestionPartLocators.question_need_several)
        question_need_several.click_on_question(QuestionPartLocators.question_need_several)
    ...
    def test_question_time_of_rent(self, driver):
        ...
        question_time_of_rent.scroll_to_question(QuestionPartLocators.question_time_of_rent)
        question_time_of_rent.click_on_question(QuestionPartLocators.question_time_of_rent)
    ...
    def test_question_order_for_today(self, driver):
        ...
        question_order_for_today.scroll_to_question(QuestionPartLocators.question_order_for_today)
        question_order_for_today.click_on_question(QuestionPartLocators.question_order_for_today)
    ...
    def test_question_use_longer_return_earlier(self, driver):
        ...
        question_use_longer_return_earlier.scroll_to_question(QuestionPartLocators.question_use_longer_return_earlier)
        question_use_longer_return_earlier.click_on_question(QuestionPartLocators.question_use_longer_return_earlier)
    ...
    def test_question_about_charger(self, driver):
        ...
        question_about_charger.scroll_to_question(QuestionPartLocators.question_about_charger)
        question_about_charger.click_on_question(QuestionPartLocators.question_about_charger)
    ...
    def test_question_cancel_order(self, driver):
        ...
        question_cancel_order.scroll_to_question(QuestionPartLocators.question_cancel_order)
        question_cancel_order.click_on_question(QuestionPartLocators.question_cancel_order)
    ...
    def test_question_live_behind_MKAD(self, driver):
        ...
        question_live_behind_MKAD.scroll_to_question(QuestionPartLocators.question_live_behind_MKAD)
        question_live_behind_MKAD.click_on_question(QuestionPartLocators.question_live_behind_MKAD)
